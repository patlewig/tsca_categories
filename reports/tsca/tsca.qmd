...
| Lipinski's Rules                    | Failures \< 3                             | Lipinski's rules denote likely oral absorption based on LogKow \<, MW \< 500 and Hydrogen bond donor or acceptors (\< 10 or \< 5). 2 failures permitted |     |
...
No structural alert cluster profiles were produced for 16 terminal categories - namely ('Allenes', nan), ('Anthracenes', 2.0), ('Anthracenes', 3.0), ('Anthracenes', 5.0), ('Azobenzenes', 1.0), ('Azobenzenes', 2.0), ('Azobenzenes', 5.0), ('Azobenzenes', 6.0), ('Azobenzenes', 7.0), ('Azoles', 3.0), ('Benzenoids', 5), ('Lignans, neolignans and related compounds', nan), ('Organic oxygen compounds', nan), ('Organoheterocyclic compounds', 2.0), ('Quinolines and derivatives', 1.0) and ('Quinolines and derivatives', 2.0).

Of these, ('Allenes', nan), ('Azoles', 3.0) and ('Lignans, neolignans and related compounds', nan) all had low memberships (2,4,6 respectively) which might limit the potential for an prediction to be triggered. For the other 13 terminal categories, each was associated with a number of positive endpoint-model predictions as shown in @tbl-terms. For example, terminal category ('Anthracenes', 5) was associated with 10 endpoint-models that were positive for all 16 members. The endpoints associated with these 10 model predictions were carcinogenicity, Ames mutagenicity, developmental toxicity, skin sensitisation, eye irritation and *in vitro* micronucleus activity.
